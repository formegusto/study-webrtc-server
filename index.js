...
const createReceiverPeerConnection = (socketID, socket, roomID, role) => {
...
const getOtherUsersInRoom = (socketID, roomID, role) => {
  let allUsers = [];
...
io.sockets.on("connection", (socket) => {
  socket.on("joinRoom", (data) => {
    try {
      let allUsers = getOtherUsersInRoom(data.id, data.roomID, data.role);
